...
flowchart TD
      subgraph main.h
       ...
       style dinner_cmd fill:#bbf,stroke:#B366FF,stroke-width:2px,color:#fff,stroke-dasharray: 3 3
       ...
       style inner_cmd fill: #FFDE6C,stroke:#FFCB17,stroke-width:2px
       ...
       style Definend fill: #CFE2E7,stroke:#A3C9D1,stroke-width:2px
        ...
        Libraries --> main.c["int main(int ac, char *av[], char *ev[]);\nvoid handle_signal(int signal);"]
        ...
        get_cmd --> inner_cmd["int inner_cmd(const char *cmd, char *ev[]);"]
        dinner_cmd(["Prototypes inner_cmd"]) -.->inner_cmd
        inner_cmd-->Definend[/"#endif"/]
        Definend--> endbox("END")
